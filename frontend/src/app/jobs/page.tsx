                    ...
                    <div className="flex flex-wrap gap-3">
                      ...
                      {job.employmentTypes && job.employmentTypes.length > 0 ? (
                        <div className="flex items-center gap-1.5 rounded-lg bg-orange-50 px-3 py-1.5 text-xs font-bold text-orange-700">
                          <Briefcase className="h-3.5 w-3.5 shrink-0" />
                          {job.employmentTypes[0]} {job.employmentTypes.length > 1 ? `+${job.employmentTypes.length - 1}` : ''}
                        </div>
                      ) : null}
                      {job.workSchedule && job.workSchedule.length > 0 ? (
                        <div className="flex items-center gap-1.5 rounded-lg bg-pink-50 px-3 py-1.5 text-xs font-bold text-pink-700">
                          <Clock className="h-3.5 w-3.5 shrink-0" />
                          {job.workSchedule.length} Gün
                        </div>
                      ) : null}
                      {job.hideSalary ? (
